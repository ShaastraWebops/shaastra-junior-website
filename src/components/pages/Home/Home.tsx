  ...
  return (
    <CustomBox>
      <div className="home-landing-section">
        ...
        <div className="home-landing-subhead-date">
          24th - 26th Sep | 1st - 3rd Oct
        </div>
        ...
        {role === "ADMIN" && (
          <Flex alignItems={"center"} flexDirection={["column", "row"]}>
            <Flex fontSize={"2xl"}>
              Total Number of Registration: {count?.getUsersCount}
            </Flex>
            <Button
      ...
      <div className="who-are-we-container">
        ...
        <div className="who-are-we">
          ...
          <div className="who-are-we-content">
            ...
            completely online Tech fest specially aimed at spreading technical
            awareness among school students (Class 1 - 12). A fun filled weekend
                    ...
                    {parse(
                      converter.makeHtml(
                        dat.description.length > 100
                          ? dat.description.substring(
                              0,
                              window.innerWidth < 600 ? 175 : 235
                            ) + "..."
                          : dat.description
                      )
                    )}
        ...
        <div className="prev-year-card-container">
          ...
          <div className="prev-year-card">
            ...
            <div className="prev-year-card-content">
              ...
              the test with exceptionally tricky questions. Qualify the prelims
              to battle it out with the brightest of minds in the finals.
            </div>
          </div>
      ...
      <div>
        ...
        <Box width="100%">
          ...
          >
            ...
            <Image
              style={{ objectFit: "contain" }}
              src={Amar_Chitra_Katha}
              width="400px"
              height="250px"
              p={8}
              alt="Amar-Chitra-Katha"
            />
          </Flex>
        </Box>
      </div>
