...
import { Box, Button, Center, FormControl, Input, Container, Flex, Heading, Image, Spacer, Table, TableCaption, Tag, TagLabel, Tbody, Td, Text, Th, Thead, Tr, Tfoot } from "@chakra-ui/react";
                    ...
                    <Tbody>
                        <Tr>
                            <Td><Text
                                ...
                                p={2} m={2}>
                                    Audience :</Text></Td>
                            <Td><Tag variant="solid" colorScheme={'blue'} paddingX={"20px"} paddingY={"7px"} m={1} borderRadius={"16px"}
                        ...
                        <Tr> */}
                            <Td><Text
                                ...
                                p={2} m={2}>
                                    Platform :</Text></Td>
                            <Td><Tag variant="solid" colorScheme={'blue'} paddingX={"20px"} paddingY={"7px"} borderRadius={"16px"} m={1}
                            > <TagLabel fontSize={'md'}>{event?.platform}</TagLabel></Tag></Td>
                        ...
                        <Tr> */}
                            <Td> <Text
                                ...
                                fontSize={'20px'}
                                p={2} m={2}>
                                    Requirements :</Text></Td>
                            <Td><Tag variant="solid" colorScheme={'blue'} paddingX={"20px"} paddingY={"7px"} borderRadius={"16px"} m={1}
                            > <TagLabel fontSize={'md'}>{event?.requirements}</TagLabel></Tag></Td>
                        {/* </Tr>
                        <Tr> */}
                            <Td><Text
                                fontWeight={'medium'}
                            ...
                            <Td><Tag variant="solid" colorScheme={'blue'} paddingX={"20px"} paddingY={"7px"} borderRadius={"16px"} m={1}
                                    > <TagLabel fontSize={'md'}>{event?.registrationType}</TagLabel></Tag></Td>
                        </Tr>
                    </Tbody>
                </Table>
                    ...
                    {/* <Center>
                        <Flex flexDirection={['column', 'column', 'row']}>
                            <Text
                                ...
                                <Center>
                                    Audience :
                                    <Tag variant="solid" colorScheme={'blue'} paddingX={"20px"} paddingY={"7px"} m={1} borderRadius={"16px"}
                                    > <TagLabel fontSize={'md'}>
                                            {
                                                audience.length > 1 ? (audience[0] + " th - " + audience[(audience.length - 1)] + " th ") :
                                                    audience[0] + " th"
                                ...
                                event?.platform ?
                                    <Text
                                        ...
                                        <Center>
                                            ...
                                            Platform :
                                            <Tag variant="solid" colorScheme={'blue'} paddingX={"20px"} paddingY={"7px"} borderRadius={"16px"} m={1}
                    ...
                    <Center>
                        <Flex flexDirection={['column', 'column', 'row']}>

                            {
                                ...
                                >
                                    <Center>
                                        Registration : <Tag variant="solid" colorScheme={'blue'} paddingX={"20px"} paddingY={"7px"} borderRadius={"16px"} m={1}
                                ...
                                >
                                    <Center>
                                        Maximum Team Size : <Tag variant="solid" colorScheme={'blue'} paddingX={"20px"} paddingY={"7px"} borderRadius={"16px"} m={1}
