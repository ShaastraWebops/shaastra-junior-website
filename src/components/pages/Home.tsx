      ...
      <Box className="mainn" color="#FFE5E5" width="100vw" height="100%" paddingTop={'80px'}>
        <Stack>
          ...
          <Flex width="100%" overflow="hidden" display="flex" flexWrap="wrap" justifyContent="center">
            <Swiper breakpoints={{596:{slidesPerView:2}}} spaceBetween={40} className="mySwiper">
          ...
          <Swiper  breakpoints={{596:{slidesPerView:2}}} spaceBetween={40} pagination={{ "clickable": true }} className="mySwiper">
            <SwiperSlide><Slider2 /></SwiperSlide>
            <SwiperSlide><Slider2 /></SwiperSlide>
            <SwiperSlide><Slider2 /></SwiperSlide>
            <SwiperSlide><Slider2 /></SwiperSlide>
          ...
          <Box>
            ...
            <Flex flexDirection="row" justifyContent="flex-start">
              ...
              <Image src={ppl5} className="bg2" width="30%" alt=""></Image>
            </Flex>
